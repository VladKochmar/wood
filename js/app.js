 ...
 */
    ...
    (() => {
        ...
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+380 99 999 99 99").mask(inputMasks);
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (handle) priceEnd.value = Math.round(value); else priceStart.value = Math.round(value);
                }));
        ...
        function initSliders() {
            if (document.querySelector(".product__slider")) new core(".product__slider", {
                modules: [ Navigation, Lazy, EffectFade, Thumb ],
                slidesPerView: 1,
                speed: 800,
                lazy: true,
                loop: true,
                effect: "fade",
                navigation: {
                    prevEl: ".mini-product-button-prev",
                    nextEl: ".mini-product-button-next"
                },
                thumbs: {
                    swiper: {
                        el: ".mini-product__slider",
                        slidesPerView: 5,
                        spaceBetween: 15,
                        setBreakpoint: {
                            390: {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                pagination: {
                    type: "fraction",
                    el: ".main-block-fraction",
                    clickable: true
                },
                navigation: {
                    prevEl: ".main-block-slider-button-prev",
                    nextEl: ".main-block-slider-button-next"
                },
                on: {}
            });
            if (document.querySelector(".images-slider__slider")) new core(".images-slider__slider", {
            ...
            if (document.querySelectorAll(".item-product__slider").length) document.querySelectorAll(".item-product__slider").forEach((sliderItem => {
                new core(sliderItem, {
        ...
        document.addEventListener("click", (e => {
            ...
            if (targetElement.closest(".sidebar-catalog__opne-filter")) {
                const filterBlock = document.querySelector(".form-filter");
                bodyLock();
                filterBlock.classList.add("_open-filter");
            }
            if (targetElement == document.querySelector(".header-filter__hide")) {
                const filterBlock = document.querySelector(".form-filter");
                bodyUnlock();
                filterBlock.classList.remove("_open-filter");
            }
        }));
        window["FLS"] = true;
        isWebp();
